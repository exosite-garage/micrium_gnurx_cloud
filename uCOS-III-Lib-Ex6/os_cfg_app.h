...
#define  OS_CFG_IDLE_TASK_STK_SIZE       256u               /* Stack size (number of CPU_STK elements)                */
                                                            ...
                                                            /* ------------------ ISR HANDLER TASK ------------------ */
#define  OS_CFG_INT_Q_SIZE                 1u               /* Size of ISR handler task queue                         */
#define  OS_CFG_INT_Q_TASK_STK_SIZE      256u               /* Stack size (number of CPU_STK elements)                */


                                                            /* ------------------- STATISTIC TASK ------------------- */
#define  OS_CFG_STAT_TASK_PRIO             4u               /* Priority                                               */
...
#define  OS_CFG_TICK_TASK_STK_SIZE       256u               /* Stack size (number of CPU_STK elements)                */
...
#define  OS_CFG_TMR_TASK_RATE_HZ           4u               /* Rate for timers (10 Hz Typ.)                           */
#define  OS_CFG_TMR_TASK_STK_SIZE        288u               /* Stack size (number of CPU_STK elements)                */
